...
public class MapLightText : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Opposition && !All)
        {
            ...
            text.color = new Color((1 - Brightness) * color.r, (1 - Brightness) * color.g, (1 - Brightness) * color.b, color.a);
        }
        else if (!All)
        {
            if (TimeControl.GameTime >= 10000 && TimeControl.GameTime <= 13800)
            ...
            text.color = new Color(Brightness * color.r, Brightness * color.g, Brightness * color.b, color.a);
        }
