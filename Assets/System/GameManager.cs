...
public class GameManager : MonoBehaviour
{
    ...
    public static float PlayerAttack = 1;
    ...
    //맵
    public static string Chapter = "Tutorial";
    ...
    public void saveData(bool GameOver)
    {
        ...
        SaveData.playerData.Chapter = Chapter;
    ...
    public static void loadData()
    {
        ...
        Chapter = SaveData.playerData.Chapter;
    ...
    public void PlayerDataReset(bool b)
    {
        ...
        if (dataReset_i == 4 || !b)
        {
            if (!isAction)
            {
                ...
                SaveData.playerData.Chapter = "Tutorial";
